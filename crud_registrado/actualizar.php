    ...
    <body>
        <div class="container mt-5">
            ...
            <input type="text" class="form-control mb-3" name="id" placeholder="id" value="<?php echo $row['id']  ?>">
                ...
                <input type="text" class="form-control mb-3" name="fecha_nac" placeholder="fecha_nac" value="<?php echo $row['fecha_nac']  ?>">
                <input type="text" class="form-control mb-3" name="lugar_nac" placeholder="lugar_nac" value="<?php echo $row['lugar_nac']  ?>">
                <input type="text" class="form-control mb-3" name="genero" placeholder="genero" value="<?php echo $row['genero']  ?>">
                <input type="text" class="form-control mb-3" name="presentado" placeholder="presentado" value="<?php echo $row['presentado']  ?>">
